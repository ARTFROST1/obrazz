...
export interface WardrobeHeaderMenuItem {
  id: string;
...
interface WardrobeHeaderProps {
  ...
  menuItems: WardrobeHeaderMenuItem[];
  /**
...
/**
 * WardrobeHeader - Unified header component for wardrobe screen
 *
 ...
 *
 * const menuItems: WardrobeHeaderMenuItem[] = [
 ...
 * ```
 */
export const WardrobeHeader: React.FC<WardrobeHeaderProps> = ({
  searchValue,
  onSearchChange,
  ...
  return (
    ...
    >
      <SearchBar
        ...
        variant="rounded"
      />
      <DropdownMenu items={dropdownMenuItems} style={styles.standardMenu} position="right" />
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  // Standard styles for Android / iOS < 26
  standardContainer: {
    position: 'absolute',
    left: 16,
    right: 16,
