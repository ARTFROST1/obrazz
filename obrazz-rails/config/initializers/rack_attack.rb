...
class Rack::Attack
  ### Configure Cache ###
  # IMPORTANT: Rack::Attack initializes BEFORE Rails connects to database,
  # so we cannot use Solid Cache (which requires database connection).
  # Using dedicated MemoryStore instead.
