...
> **Статус:** Stage 4.12 завершён, переход к Stage 5+
...
**Следующие этапы** требуют принятия архитектурных решений по:

1. **AI-функции** — интеграция The New Black API
2. **Backend** — выбор стека и хостинга
3. **Платежи** — IAP + веб-биллинг (гибридная модель)
4. **Нативные функции** — Apple Vision для удаления фона, контекстные меню
...
4. [Анализ Backend стека](#анализ-backend-стека)
5. [AI-функции и примерка](#ai-функции-и-примерка-образов)
6. [Нативные функции iOS](#нативные-функции-ios)
7. [Платежная система](#платежная-система)
8. [Хранение данных и политика](#хранение-данных-и-политика)
9. [Детальный Roadmap по стадиям](#детальный-roadmap-по-стадиям)

---

## ✅ Что уже сделано (Stage 1-4.12)
