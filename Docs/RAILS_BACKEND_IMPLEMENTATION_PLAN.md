...
> ⚠️ **АРХИВНЫЙ ДОКУМЕНТ** (февраль 2026)
>
> Этот документ описывает план для **монолитного Rails backend** (`obrazz-rails`),
> который был **архивирован** и заменён двумя отдельными сервисами:
>
> | Сервис          | Стек                        | Назначение                                                             |
> | --------------- | --------------------------- | ---------------------------------------------------------------------- |
> | `obrazz-api/`   | Node.js + Hono + TypeScript | API для мобильного приложения (AI/FASHN AI, токены, платежи, подписки) |
> | `obrazz-admin/` | Rails 8.0.4                 | Админ-панель (аналитика, модерация, управление пользователями)         |
>
> **AI-провайдер сменён:** The New Black → **FASHN AI** (api.fashn.ai/v1)
>
> Документ сохранён для исторической справки. Актуальную архитектуру см.:
>
> - `obrazz-api/README.md` — Node.js/Hono backend
> - `obrazz-admin/README.md` — Rails admin panel
> - `.github/copilot-instructions.md` — актуальный обзор экосистемы

---

> **Дата создания:** 27 января 2026  
> **Версия:** 1.0.1  
> **Статус:** ❌ АРХИВИРОВАНО (заменено на obrazz-api + obrazz-admin)  
