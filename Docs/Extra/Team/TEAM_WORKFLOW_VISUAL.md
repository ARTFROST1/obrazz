...
> ⚠️ NOTE (2026-01-26): документ носит плановый/исторический характер. Community/социальные фичи удалены из проекта; используйте `Docs/CURRENT_STATUS.md` и `Docs/Implementation.md` как источник правды.
...
═══════╪═════════════════════════════════╪═════════════════════════════════╪═══════════
   1   │ Wardrobe UI                     │ Item Service + Storage          │ День 2,4,6
       ...
       │ • Add Item Screen               │ • Pixian.ai integration         │
...
```
            ...
            └───────┬────────┘                        └────────┬────────┘
                ...
                │                                        │
        ┌───────▼────────┐                      ┌───────▼────────┐
       │ Tokens/UX Track │                     │  AI Generation │
        │   (5-6 дней)   │                      │   (7-8 дней)   │
       │ (no community) │                      │    Stage 5     │
        └───────┬────────┘                      └───────┬────────┘
                │                                        │
                └────────────────┬───────────────────────┘
                                 │
...
└── shopping/                  ✓ Dev A
       └── ... (web capture / shopping UI components)
```
