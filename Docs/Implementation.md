...
- [ ] Обновление outfitStore для поддержки двухэтапного процесса
  - [ ] Добавить состояние creationStep (1 | 2)
  - [ ] Добавить selectedItemsForCreation Map
  - [ ] Реализовать actions для управления шагами

- [ ] Создание компонентов для Step 1 (Выбор одежды)
  - [ ] CategorySelectorList - вертикальный список каруселей
  - [ ] ItemSelectionStep - обертка для Step 1
  - [ ] ProgressIndicator - индикатор прогресса выбора
  - [ ] Обновить CategoryCarousel для увеличенного размера

- [ ] Создание компонентов для Step 2 (Композиция)
  - [ ] ItemMiniPreviewBar - нижняя панель с мини-превью
  - [ ] CompositionStep - обертка для Step 2
  - [ ] Toolbar с контролами (Undo/Redo/Background/Clear)

- [ ] Рефакторинг create.tsx
  - [ ] Реализовать переключение между шагами
  - [ ] Навигация между Step 1 и Step 2
  - [ ] Сохранить Randomize функциональность на обоих шагах
  - [ ] Edit mode: загрузка outfit сразу на Step 2
...
- [ ] Обновление документации
  - [ ] AppMapobrazz.md - новый flow создания образа
  - [ ] UI_UX_doc.md - спецификации для новых компонентов
  - [ ] OUTFIT_CREATOR_REFACTOR_PLAN.md - детальный план

- [ ] Тестирование
  - [ ] Создание нового образа через 2 шага
  - [ ] Редактирование существующего образа
  - [ ] Randomize на обоих шагах
