...
- [ ] Интеграция Supabase Auth с JWT токенами
- [ ] Настройка Zustand store для хранения состояния авторизации
- [ ] Реализация автоматического refresh токенов
- [ ] Создание HOC для защищенных маршрутов
- [ ] Базовый экран профиля с возможностью выхода
- [ ] Обработка ошибок авторизации с user-friendly сообщениями
...
- [ ] Настройка локального хранения изображений (expo-file-system)
- [ ] Создание формы метаданных для вещей (категория, цвет, стиль, сезон)
- [ ] Интеграция Remove.bg API для удаления фона
- [ ] Реализация просмотра детальной информации о вещи
- [ ] Функционал редактирования метаданных вещи
- [ ] Реализация удаления вещей с подтверждением
- [ ] Фильтрация и сортировка вещей по категориям/цветам
- [ ] Оптимизация производительности для больших коллекций (>100 items)
...
- [ ] Реализация масштабирования и поворота элементов (pinch/rotate)
- [ ] Функция блокировки категорий при рандомизации
- [ ] Кнопка "Рандом" для случайной генерации
- [ ] Выбор и смена фонов коллажа
- [ ] Сохранение позиций и трансформаций элементов
- [ ] Сохранение готового образа в БД
- [ ] Редактирование сохраненных образов
- [ ] Экспорт образа как изображения
