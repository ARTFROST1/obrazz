...
1. **Главная** — лента, подборки, комьюнити.
2. **Гардероб** — просмотр, добавление, редактирование вещей.
3. **Образы** — просмотр, фильтрация, сортировка, редактирование.
4. **Создание образа** — ручной конструктор (scroll-карусели + коллаж).
5. **AI-подборка** — автоматическая генерация луков.
6. **Профиль** — данные пользователя, подписка.
7. **Настройки** — тема, язык, уведомления.
8. **Онбординг** — в конце первой сессии, показывает функции приложения.
